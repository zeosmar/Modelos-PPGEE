...
\fancyhf{}
\fancyhead[C]{\includegraphics[height=25mm,width=\textwidth]{Templates/Qualificacao/image001.png}}
\fancyfoot[R]{%
  \textcolor{black}{\rlap{%
      \colorbox{white}{\hspace*{1cm}\makebox[0.5cm][r]{\sffamily\bfseries\thepage}}}}}
\fancyfoot[C]{\includegraphics[height=25mm,width=\textwidth]{Templates/Qualificacao/image002.png}}
...
\begin{figure}[!htb]
    ...
    \begin{subfigure}[b]{0.4\linewidth}        %% or \columnwidth
        \centering
        \includegraphics[width=\linewidth]{Templates/Qualificacao/images/restnet1.png}
    ...
    \begin{subfigure}[b]{0.4\linewidth}        %% or \columnwidth
        \centering
        \includegraphics[width=\linewidth]{Templates/Qualificacao/images/restnet2.png}
